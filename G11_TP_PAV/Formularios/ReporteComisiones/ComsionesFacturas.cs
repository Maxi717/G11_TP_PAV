...
{
    public partial class ComisionesFacturas : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            tabla = contrato.ListadoFacturasComisiones();
            this.reportViewer1.RefreshReport();
            ReportDataSource datos = new ReportDataSource("DataSet1", tabla);
            reportViewer1.LocalReport.ReportEmbeddedResource = "G11_TP_PAV.Formularios.ReporteComisiones.ReportComisiones.rdlc";
